    ...
    <div className="pomodoro-information">
      ...
      <section id="how-to-use">
        ...
        <ol>
          ...
          <li>Repeat the process, taking a longer break (15-30 minutes) after every four Pomodoros.</li>
        </ol>
      </section>
      ...
      <section id="tips">
        ...
        <ul>
          ...
          <li>Use a Pomodoro timer to track intervals.</li>
